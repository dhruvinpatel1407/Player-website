    ...
    <div className="min-h-screen flex flex-col items-center justify-center bg-blue-50 text-black p-10 space-y-10">
      <div className="bg-white shadow-lg rounded-lg p-8 w-full max-w-3xl">
        ...
        <p className="text-gray-700 text-center mb-6">
          We&rsquo;d love to hear your feedback! Please share your experience with us.
        </p>
        {responses.length > 0 && (
        ...
        >
          ...
          <div className="col-span-1 sm:col-span-2">
            <textarea
              ...
              onChange={handleChange}
              className="w-full p-3 border border-gray-400 rounded-lg mt-1 h-24 placeholder-gray-500"
              required
            ></textarea>
          </div>
      ...
      <div className="w-full max-w-5xl">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          ...
          <div className="bg-white shadow-md rounded-lg p-6 text-center">
            ...
            <p className="text-yellow-500 text-lg">★★★☆☆</p>
            <p className="text-gray-800 mt-2">
              Good, but can be improved in some areas.
            </p>
          </div>
          {responses.length > 0 &&
